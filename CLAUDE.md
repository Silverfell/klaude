...
- `upgrade.sh`: overwrites an existing install with the latest defaults, migrates a legacy text `CHANGES.md` into `changes.db`, and retires the legacy `/init` and `/compresschanges` commands.
